    ...
    <Fragment>
      ...
      <div className="page">
        ...
        <div className="stat-grid reveal" style={{ gridTemplateColumns: "repeat(4, 1fr)", marginTop: 52, marginBottom: 8 }}>
          <div className="stat-cell"><div className="k">아카이브 영상</div><div className="v">{VIDEOS.length}</div></div>
...
/* ---------- Upload ---------- */
export function Upload({ go }) {
  useReveal();
  const [stages, setStages] = useState(() => PROCESSING.stages.map(s => ({ ...s })));
